<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="LItanProject.Pages.Edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="register-container">
            <div class="register-form">
                <table class="register-table" style="border-spacing: 10px; border: solid 2px black; background-color:whitesmoke;">
                    <tr>
                        <td class="tbl-right">
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <input type="submit" id="submit" name="Edit" class="btn-login" value="Edit" disabled="disabled" />
                        </td>
                    </tr>
                </table>
            </div>
